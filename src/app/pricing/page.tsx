              ...
              return (
                <div
                  ...
                  className={cn('relative rounded-2xl bg-white shadow-lg', {
                    'border-2 border-primary shadow-[#ff80b5]': plan === 'Pro',
                    'border border-gray-200': plan !== 'Pro',
                  })}
                >
                  {/* TODO -- change up the colors here */}
                  {plan === 'Pro' && (
                    <div className='absolute -top-5 left-0 right-0 mx-auto w-32 rounded-full bg-gradient-to-r from-yellow-500 to-[#ff80b5] px-3 py-2 text-sm font-medium text-white'>
                      Upgrade now
                    </div>
                  )}
