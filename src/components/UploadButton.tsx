        ...
        <div {...getRootProps()} className='border h-64 m-4 border-dashed border-gray-300 rounded-lg'>
          <div className='flex items-center justify-center h-full w-full'>
            <label
              ...
              className='flex flex-col items-center justify-center w-full h-full rounder-lg cursor-pointer bg-gray-50 hover:bg-gray-100'
            >
              ...
              {acceptedFiles && acceptedFiles[0] ? (
                <div className='max-w-xs bg-white flex items-centerrounded-md overflow-hidden outline outline-[1px] outline-zinc-200 divide-x divide-zinc-200'>
                  <div className='px-3 py-2 h-full grid place-items-center'>
                    <FileUp className='h-[17.5px] w-[17.5px] text-primary' />
                  </div>
              ...
              {isUploading ? (
                <div className='w-full mt-4 max-w-xs mx-auto'>
                  <Progress
                    indicatorColor={uploadProgress === 100 ? 'bg-[#ff80b5]' : ''}
              ...
              {/* TODO -- Fix duplicated upload window */}
